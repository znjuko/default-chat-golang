...
!(function () {
	...
	const c = function (e, t) {
		!(function (e, t) {
			...
			if (
				...
				const d = (r.body || r.getElementsByTagName('head')[0])
					.childNodes;
				n = d[d.length - 1];
			}
	...
	const e = function (e, t, n) {
		...
		(a.src = e),
			void 0 !== r &&
				a.setAttribute('data-auto-a11y', r ? 'true' : 'false'),
			i &&
				(a.setAttributeNode(
		...
		if (window.FontAwesomeKitConfig) {
			...
			f.method === 'js' &&
				...
				m.detectingConflicts &&
					((u = document.currentScript.getAttribute(
						m.detectionTimeoutAttr
